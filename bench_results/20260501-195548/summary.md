...
- baseline model: `/Users/surindersingh/models/surt-small-v3-int8`  beam: `5`  vad: `off`

| Backend | Dataset | N | WER% | CER% | RTF (×realtime) | First-decode (s) | Peak RAM (MB) | Notes |
|---|---|---:|---:|---:|---:|---:|---:|---|
| `baseline-faster-whisper` | sehajpath | 50 | 13.9 | 4.3 | 0.575 | 2.87 | 2244 |  |
| `baseline-faster-whisper` | kirtan | 50 | 57.3 | 30.7 | 0.305 | 1.54 | 2301 |  |
